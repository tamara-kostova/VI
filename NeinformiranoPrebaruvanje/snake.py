...
def izedeno_jabolko(glavax, glavay, jabolka):
    for (x,y) in jabolka:
...
class Snake (Problem):
    def __init__(self, initial, crveni_jabolki):
        super().__init__(initial)
        self.crveni_jabolki = crveni_jabolki

    def successor(self, state):
        succ = dict()
        glava_x, glava_y = state[0][0], state[0][1]
        telo = state[1]
        nasoka = state[2]
        jabolka = state[3]
        if nasoka=='dolu':
            if glava_y-1>=0 and (glava_x,glava_y-1) not in telo and (glava_x,glava_y-1) not in self.crveni_jabolki:
                if izedeno_jabolko(glava_x,glava_y-1,jabolka):
                    new_telo = list(telo)
                    new_telo.insert(0, (glava_x, glava_y-1))
                    succ["ProdolzhiPravo"] = ((glava_x, glava_y-1), tuple(new_telo), "dolu",
                                              tuple([j for j in jabolka if [glava_x, glava_y-1] != [j[0], j[1]]]))
                else:
                    new_telo = list(telo)
                    new_telo.pop()
                    new_telo.insert(0, (glava_x, glava_y-1))
                    succ["ProdolzhiPravo"] = ((glava_x, glava_y-1), tuple(new_telo), "dolu", tuple(jabolka))
            if glava_x - 1 >= 0 and (glava_x-1,glava_y) not in telo and (glava_x-1,glava_y) not in self.crveni_jabolki:
                if izedeno_jabolko(glava_x-1, glava_y, jabolka):
                    new_telo = list(telo)
                    new_telo.insert(0, (glava_x-1, glava_y))
                    succ["SvrtiDesno"] = ((glava_x-1, glava_y), tuple(new_telo), "levo",
                                              tuple([j for j in jabolka if [glava_x-1, glava_y] != [j[0], j[1]]]))
                else:
                    new_telo = list(telo)
                    new_telo.pop()
                    new_telo.insert(0, (glava_x-1, glava_y))
                    succ["SvrtiDesno"] = ((glava_x-1, glava_y), tuple(new_telo), "levo", tuple(jabolka))
            if glava_x + 1 < 10 and (glava_x+1,glava_y) not in telo and (glava_x+1,glava_y) not in self.crveni_jabolki:
                if izedeno_jabolko(glava_x+1, glava_y, jabolka):
                    new_telo = list(telo)
                    new_telo.insert(0, (glava_x+1, glava_y))
                    succ["SvrtiLevo"] = ((glava_x+1, glava_y), tuple(new_telo), "desno",
                                              tuple([j for j in jabolka if [glava_x+1, glava_y] != [j[0], j[1]]]))
                else:
                    new_telo = list(telo)
                    new_telo.pop()
                    new_telo.insert(0, (glava_x+1, glava_y))
                    succ["SvrtiLevo"] = ((glava_x+1, glava_y), tuple(new_telo), "desno", tuple(jabolka))

        if nasoka=='gore':
            if glava_y+1<10 and (glava_x,glava_y+1) not in telo and (glava_x,glava_y+1) not in self.crveni_jabolki:
                if izedeno_jabolko(glava_x,glava_y+1,jabolka):
                    new_telo = list(telo)
                    new_telo.insert(0, (glava_x, glava_y+1))
                    succ["ProdolzhiPravo"] = ((glava_x, glava_y+1), tuple(new_telo), "gore",
                                              tuple([j for j in jabolka if [glava_x, glava_y+1] != [j[0], j[1]]]))
                else:
                    new_telo = list(telo)
                    new_telo.pop()
                    new_telo.insert(0, (glava_x, glava_y+1))
                    succ["ProdolzhiPravo"] = ((glava_x, glava_y+1), tuple(new_telo), "gore", tuple(jabolka))
            if glava_x - 1 >= 0 and (glava_x-1,glava_y) not in telo and (glava_x-1,glava_y) not in self.crveni_jabolki:
                if izedeno_jabolko(glava_x-1, glava_y, jabolka):
                    new_telo = list(telo)
                    new_telo.insert(0, (glava_x-1, glava_y))
                    succ["SvrtiLevo"] = ((glava_x-1, glava_y), tuple(new_telo), "levo",
                                              tuple([j for j in jabolka if [glava_x-1, glava_y] != [j[0], j[1]]]))
                else:
                    new_telo = list(telo)
                    new_telo.pop()
                    new_telo.insert(0, (glava_x-1, glava_y))
                    succ["SvrtiLevo"] = ((glava_x-1, glava_y), tuple(new_telo), "levo", tuple(jabolka))
            if glava_x + 1 < 10 and (glava_x+1,glava_y) not in telo and (glava_x+1,glava_y) not in self.crveni_jabolki:
                if izedeno_jabolko(glava_x+1, glava_y, jabolka):
                    new_telo = list(telo)
                    new_telo.insert(0, (glava_x+1, glava_y))
                    succ["SvrtiDesno"] = ((glava_x+1, glava_y), tuple(new_telo), "desno",
                                              tuple([j for j in jabolka if [glava_x+1, glava_y] != [j[0], j[1]]]))
                else:
                    new_telo = list(telo)
                    new_telo.pop()
                    new_telo.insert(0, (glava_x+1, glava_y))
                    succ["SvrtiDesno"] = ((glava_x+1, glava_y), tuple(new_telo), "desno", tuple(jabolka))
        ...
        if nasoka=='desno':
            if glava_x + 1 < 10 and (glava_x+1,glava_y) not in telo and (glava_x+1,glava_y) not in self.crveni_jabolki:
                if izedeno_jabolko(glava_x+1, glava_y, jabolka):
                    new_telo = list(telo)
                    new_telo.insert(0, (glava_x+1, glava_y))
                    succ["ProdolzhiPravo"] = ((glava_x+1, glava_y), tuple(new_telo), "desno",
                                              tuple([j for j in jabolka if [glava_x+1, glava_y] != [j[0], j[1]]]))
                else:
                    new_telo = list(telo)
                    new_telo.pop()
                    new_telo.insert(0, (glava_x+1, glava_y))
                    succ["ProdolzhiPravo"] = ((glava_x+1, glava_y), tuple(new_telo), "desno", tuple(jabolka))

            if glava_y+1<10 and (glava_x,glava_y+1) not in telo and (glava_x,glava_y+1) not in self.crveni_jabolki:
                if izedeno_jabolko(glava_x,glava_y+1,jabolka):
                    new_telo = list(telo)
                    new_telo.insert(0, (glava_x, glava_y+1))
                    succ["SvrtiLevo"] = ((glava_x, glava_y+1), tuple(new_telo), "gore",
                                              tuple([j for j in jabolka if [glava_x, glava_y+1] != [j[0], j[1]]]))
                else:
                    new_telo = list(telo)
                    new_telo.pop()
                    new_telo.insert(0, (glava_x, glava_y+1))
                    succ["SvrtiLevo"] = ((glava_x, glava_y+1), tuple(new_telo), "gore", tuple(jabolka))
            if glava_y - 1 >= 0 and (glava_x, glava_y - 1) not in telo and (glava_x,glava_y-1) not in self.crveni_jabolki:
                if izedeno_jabolko(glava_x, glava_y - 1, jabolka):
                    new_telo = list(telo)
                    new_telo.insert(0, (glava_x, glava_y - 1))
                    succ["SvrtiDesno"] = ((glava_x, glava_y - 1), tuple(new_telo), "dolu",
                                         tuple([j for j in jabolka if [glava_x, glava_y - 1] != [j[0], j[1]]]))
                else:
                    new_telo = list(telo)
                    new_telo.pop()
                    new_telo.insert(0, (glava_x, glava_y - 1))
                    succ["SvrtiDesno"] = ((glava_x, glava_y - 1), tuple(new_telo), "dolu", tuple(jabolka))
        ...
        if nasoka=='levo':
            if glava_x -1 >=0 and (glava_x-1,glava_y) not in telo and (glava_x-1,glava_y) not in self.crveni_jabolki:
                if izedeno_jabolko(glava_x-1, glava_y, jabolka):
                    new_telo = list(telo)
                    new_telo.insert(0, (glava_x-1, glava_y))
                    succ["ProdolzhiPravo"] = ((glava_x-1, glava_y), tuple(new_telo), "levo",
                                              tuple([j for j in jabolka if [glava_x-1, glava_y] != [j[0], j[1]]]))
                else:
                    new_telo = list(telo)
                    new_telo.pop()
                    new_telo.insert(0, (glava_x-1, glava_y))
                    succ["ProdolzhiPravo"] = ((glava_x-1, glava_y), tuple(new_telo), "levo", tuple(jabolka))
            if glava_y+1<10 and (glava_x,glava_y+1) not in telo and (glava_x,glava_y+1) not in self.crveni_jabolki:
                if izedeno_jabolko(glava_x,glava_y+1,jabolka):
                    new_telo = list(telo)
                    new_telo.insert(0, (glava_x, glava_y+1))
                    succ["SvrtiDesno"] = ((glava_x, glava_y+1), tuple(new_telo), "gore",
                                              tuple([j for j in jabolka if [glava_x, glava_y+1] != [j[0], j[1]]]))
                else:
                    new_telo = list(telo)
                    new_telo.pop()
                    new_telo.insert(0, (glava_x, glava_y+1))
                    succ["SvrtiDesno"] = ((glava_x, glava_y+1), tuple(new_telo), "gore", tuple(jabolka))
            if glava_y - 1 >= 0 and (glava_x, glava_y - 1) not in telo and (glava_x, glava_y - 1) not in self.crveni_jabolki:
                if izedeno_jabolko(glava_x, glava_y - 1, jabolka):
                    new_telo = list(telo)
                    new_telo.insert(0, (glava_x, glava_y - 1))
                    succ["SvrtiLevo"] = ((glava_x, glava_y - 1), tuple(new_telo), "dolu",
                                         tuple([j for j in jabolka if [glava_x, glava_y - 1] != [j[0], j[1]]]))
                else:
                    new_telo = list(telo)
                    new_telo.pop()
                    new_telo.insert(0, (glava_x, glava_y - 1))
                    succ["SvrtiLevo"] = ((glava_x, glava_y - 1), tuple(new_telo), "dolu", tuple(jabolka))
        return succ
    def actions(self, state):
...
if __name__ == '__main__':
    ...
    glava = [0,7]
    nasoka='dolu'
    for i in range (brzeleni):
        x,y=input().split(",")
        pozicija=(int(x),int(y))
        zeleni_jabolki.append(pozicija)
    brcrveni = int(input())
    crveni_jabolki = list()
    for i in range(brcrveni):
        x, y = input().split(",")
        pozicija = (int(x), int(y))
        crveni_jabolki.append(pozicija)
    snake = Snake((tuple(glava), tuple(telo), nasoka, tuple(zeleni_jabolki)),tuple(crveni_jabolki))
