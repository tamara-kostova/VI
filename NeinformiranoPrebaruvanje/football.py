...
class Football(Problem):
    ...
    def successor(self, state):
        ...
        if (ball_x!=6 or ball_y!= 1) and man_x == ball_x-1 and man_y == ball_y-1 and ball_x+1<8 and ball_y+1<6 and man_x+1<8 and man_y+1<6 and check_opponents(ball_x+1,ball_y+1,opponents):
            successors['Turni topka gore-desno']=((man_x+1,man_y+1),(ball_x+1,ball_y+1))
        if man_x == ball_x-1 and man_y == ball_y+1 and ball_x+1<8 and ball_y-1>=0 and man_x+1<8 and man_y-1>=0 and check_opponents(ball_x+1,ball_y-1,opponents):
