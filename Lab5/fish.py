...
if __name__=='__main__':
    ...
    col_index = int(input())
    dataset = [[row[i] for i in range(0,len(row)) if i!=col_index] for row in dataset]

    num_of_trees = int(input())
    criterion = input()
    zapis = input().split(" ")
    zapis = [zapis[i] for i in range(len(zapis)) if i!=col_index]
    ...
    classifier = RandomForestClassifier(criterion=criterion,n_estimators=num_of_trees,random_state=0)
